...
DO_APP_FUNC(0x05ADC1B0, Vector3, Input_MousePosition, (MethodInfo* method));
DO_APP_FUNC(0x0522E770, Vector2, Input_MousePosition2, (MethodInfo* method));
DO_APP_FUNC(0x04367890, float, Input_MouseSensitivity, (Rewired_InputBehavior_o* __this, MethodInfo* method));
DO_APP_FUNC(0x05161170, float, Input_MouseSensitivity2, (MoleMole_MihoyoHybridInput_o* __this, MethodInfo* method));
...
// Singletons
DO_APP_FUNC(0x06261F70, void*, Singleton_GetInstance, (MethodInfo* method));//Singleton_1_System_Object__2_GetInstance
...
//DO_APP_FUNC_METHODINFO(0x0A48B8E8, Singleton_1_PNCOENHFHGI__get_Instance__MethodInfo);
