...
namespace app {
    ...
    struct __declspec(align(8)) Rewired_InputBehavior_Fields {
        int32_t _id;
    ...
    struct Rewired_InputBehavior_VTable {
    ...
    struct Rewired_InputBehavior_c {
        Il2CppClass_1 _1;
        void* static_fields;
        Il2CppRGCTXData* rgctx_data;
        Il2CppClass_2 _2;
        Rewired_InputBehavior_VTable vtable;
    };
    struct Rewired_InputBehavior_o {
        Rewired_InputBehavior_c* klass;
        void* monitor;
        Rewired_InputBehavior_Fields fields;
    };
    ...
    struct MoleMole_MihoyoHybridInput_Fields {
        struct UnityEngine_RectTransform_o* _virtualCursor;
        bool _useVirtualCursor;
        float _virtualCursorSensitivity;
        bool EIEEPNBIPDA;
        float IIFOBNPPNLL;
        float BNEJJMHGLEB;
        float EFNJOGODOPI;
        float BNGPPHLAEDL;
        int32_t _horizontalAxis;
        int32_t _verticalAxis;
        int32_t _submitButton;
        int32_t _cancelButton;
        float _navigationDeadZone;
        float _mouseScrollScale;
        struct UnityEngine_Camera_o* JGOKLMHEIBB;
        bool _IOPONKMJKFM_k__BackingField;
        bool _FFENKLOPPCK_k__BackingField;
        bool _MLHHECMEDPI_k__BackingField;
        bool BNDIONLDCED;
        UnityEngine_Vector2_o ABGBEDLEKKG;
        UnityEngine_RectTransform_o* IKJOBPFHOGH;
    };
    struct MoleMole_MihoyoHybridInput_VTable {
        VirtualInvokeData _0_Equals;
        VirtualInvokeData _1_Finalize;
        VirtualInvokeData _2_GetHashCode;
        VirtualInvokeData _3_ToString;
        ...
        VirtualInvokeData _6_OnLightweightActivate;
        VirtualInvokeData _7_Start;
        VirtualInvokeData _8_OnDisable;
        VirtualInvokeData _9_OnLightweightDeactivate;
        VirtualInvokeData _10_OnDestroy;
        VirtualInvokeData _11_IsActive;
        VirtualInvokeData _12_OnRectTransformDimensionsChange;
        VirtualInvokeData _13_OnBeforeTransformParentChanged;
        VirtualInvokeData _14_OnTransformParentChanged;
        VirtualInvokeData _15_OnDidApplyAnimationProperties;
        VirtualInvokeData _16_OnCanvasGroupChanged;
        VirtualInvokeData _17_OnCanvasHierarchyChanged;
        VirtualInvokeData _18_IsDestroyed;
        VirtualInvokeData _19_get_compositionString;
        VirtualInvokeData _20_get_imeCompositionMode;
        VirtualInvokeData _21_set_imeCompositionMode;
        VirtualInvokeData _22_get_compositionCursorPos;
        VirtualInvokeData _23_set_compositionCursorPos;
        VirtualInvokeData _24_get_mousePresent;
        VirtualInvokeData _25_GetMouseButtonDown;
        VirtualInvokeData _26_GetMouseButtonUp;
        VirtualInvokeData _27_GetMouseButton;
        VirtualInvokeData _28_get_mousePosition;
        VirtualInvokeData _29_get_mouseScrollDelta;
        VirtualInvokeData _30_get_touchSupported;
        VirtualInvokeData _31_get_touchCount;
        VirtualInvokeData _32_GetTouch;
        VirtualInvokeData _33_GetAxisRaw;
        VirtualInvokeData _34_GetButtonDown;
    };
    struct MoleMole_MihoyoHybridInput_StaticFields {
        struct XLua_DelegateBridge_o* COGJDFIEOBI;
        struct XLua_DelegateBridge_o* NJLLIIBMKJF;
        struct XLua_DelegateBridge_o* PJPOEAAFNBI;
        struct XLua_DelegateBridge_o* HFFEIBCDKBM;
        struct XLua_DelegateBridge_o* PCCLLLLHHIO;
        struct XLua_DelegateBridge_o* BHOCPCBOEKA;
        struct XLua_DelegateBridge_o* BGBKDNNCLCN;
        struct XLua_DelegateBridge_o* HCFFOAIEMLE;
        struct XLua_DelegateBridge_o* CABFIPMNLHJ;
        struct XLua_DelegateBridge_o* NEBMJMDFJIF;
        struct XLua_DelegateBridge_o* FNNEIOLDFAJ;
        struct XLua_DelegateBridge_o* ELCIGIHADGG;
        struct XLua_DelegateBridge_o* KIAHJJGGHFM;
    };
    struct MoleMole_MihoyoHybridInput_c {
        Il2CppClass_1 _1;
        struct MoleMole_MihoyoHybridInput_StaticFields* static_fields;
        Il2CppRGCTXData* rgctx_data;
        Il2CppClass_2 _2;
        MoleMole_MihoyoHybridInput_VTable vtable;
    };
    struct MoleMole_MihoyoHybridInput_o {
        MoleMole_MihoyoHybridInput_c* klass;
        void* monitor;
        MoleMole_MihoyoHybridInput_Fields fields;
    };
