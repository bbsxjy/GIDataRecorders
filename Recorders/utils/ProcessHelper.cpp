...
bool ProcessHelper::CloseHandleByName(const wchar_t* name)
{
...
std::string ProcessHelper::GetModulePaths(HMODULE hModule)
{
...
void ProcessHelper::SetCurrentPath(const std::filesystem::path& current_path)
{
    _currentPath = current_path;
}

std::filesystem::path ProcessHelper::GetCurrentPath()
{
    return _currentPath;
}

int64_t ProcessHelper::GetCurrentTimeMillisec()
{
